...
var embedCatalog = map[string]map[string]string{
	LocaleEnglish: {
		"best":                         "Best",
		"anonymous":                    "Anonymous",
		"annotation_anchor_invalid":    "Selected text could not be anchored.",
		"annotation_comment":           "Annotation",
		"annotation_selected_required": "Selected text is required.",
		"cancel":                       "Cancel",
		"comment":                      "Comment",
	...
	LocaleUkrainian: {
		"best":                         "Найкращі",
		"anonymous":                    "Анонім",
		"annotation_anchor_invalid":    "Не вдалося привʼязати коментар до виділеного тексту.",
		"annotation_comment":           "Анотація",
		"annotation_selected_required": "Потрібно виділити текст.",
		"cancel":                       "Скасувати",
		"comment":                      "Коментар",
		...
		"view_annotation":              "Показати анотацію",
